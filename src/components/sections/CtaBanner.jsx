        ...
        <Reveal>
          <div className="edge edge-lime relative overflow-hidden rounded-3xl border border-line px-6 py-14 text-center sm:px-12 sm:py-20">
            <div aria-hidden className="absolute inset-0 -z-10">
              ...
              <div className="absolute -left-20 bottom-0 h-72 w-72 rounded-full bg-violet/20 blur-[50px] sm:blur-[110px]" />
              <div className="absolute -right-16 top-0 h-72 w-72 rounded-full bg-blue/22 blur-[50px] sm:blur-[110px]" />
              <div className="absolute left-1/2 top-1/2 h-40 w-[70%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-lime/8 blur-[45px] sm:blur-[100px]" />
              <Particles count={14} />
            </div>
